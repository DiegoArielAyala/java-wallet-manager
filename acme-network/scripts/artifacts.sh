function generateAnchorConfigurationTx() {
    msp=$1
    configtxgen -outputAnchorPeersUpdate ../channel-artifacts/${msp}anchors.tx -profile ThreeOrgsChannel -asOrg $msp -channelID marketplace # revisar si sigue la linea
}
